...
<?php Yii::app()->clientScript->registerCssFile('//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.4/fullcalendar.css'); ?>
<?php Yii::app()->clientScript->registerCssFile('//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.4/fullcalendar.print.css'); ?>
